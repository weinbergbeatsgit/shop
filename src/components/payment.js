...
const toggleCheckout = () => {
  setCheckOut(!checkout);
    ...
    <div className='flex-row gap-10 align-center'>
            ...
            <label for="agb" id="agb-label">	Ich habe die <a href="https://www.weinberg-beats.de/agb.html">allgemeinen Geschäftsbedingungen</a>  gelesen und akzeptiere diese.</label>
            </div>
